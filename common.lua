...
-- Currently supports stats that are a maximum of two indentations deep (the storage tank is an example of max stat depth). Not sure if adding more is necessary, but if will if needed.
